...
import BookAppointmentCard from './BookAppointmentCard.js'
const bookingData = [
    {
    ...
    return (
        <section>
            <Container>
                ...
                <Row className='' >
                    {
                        bookingData.map((booking, index) => (<BookAppointmentCard 
                            booking={booking} selectedDate={selectedDate} key={index}>
                        </BookAppointmentCard>))
                    }
                </Row>     
            </Container>       
